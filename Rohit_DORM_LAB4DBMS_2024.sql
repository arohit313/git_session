...
select c.*, o.* from customer c inner join `order` o on  c.cus_id = o.CUS_ID where o.ORD_AMOUNT >=3000;
...
Solution to be copied from Stored_Procedure Editor:
...
call ListSupplierRatingDetails();
